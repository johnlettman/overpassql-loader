import { stripWhitespace, stripComments } from '../src/syntax';

describe('syntax', () => {
    describe('.stripWhitespace', () => {
        it('should remove extra spaces', () => {
            const _in = 'nwr["amenity"="school"](dataset);   nwr["amenity"="university"](dataset);';
            const out = 'nwr["amenity"="school"](dataset); nwr["amenity"="university"](dataset);';
        ...
        it('should remove extra newlines', () => {
            const _in = 'nwr["amenity"="school"](dataset);\n\n\n\r\n\r\n\nnwr["amenity"="university"](dataset);';
            const out = 'nwr["amenity"="school"](dataset);\nnwr["amenity"="university"](dataset);';
            expect(stripWhitespace(_in)).toEqual(out);
        });
