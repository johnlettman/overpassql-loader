import { defaultPropertiesFilter, hasProperties, isTraversible, processProperties } from "../src/properties";
import type { PropertiesFilter } from "../src/types";

describe('properties', () => {
    const rejectNonObjects = (f: (p: any) => any) => { // eslint-disable-line @typescript-eslint/no-explicit-any
    ...
    describe('.defaultPropertiesFilter', () => {
        ...
        it('should remove any other properties', () => {
            expect(defaultPropertiesFilter({
